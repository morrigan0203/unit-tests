...
//          checkingHero();
    ...
    public static int sum(int a, int b) {
        assert (long)a + (long)b < Integer.MAX_VALUE: "Overflow, result is more then maximum";
        return a + b;
    }
    ...
    public static void checkingHero() {
        ...
        */
        ...
        assert "Emmett".equals(emmett.getName()) : "";
        assert 50 == emmett.getArmorStrength(): "";

        assertThat(emmett.getName()).isNotEmpty().hasSize(6).isEqualTo("Emmett")
                .as("Name should ne Emmett");
        assertThat(emmett.getArmorStrength()).isEqualTo(50).as("Armor Strength should be 50");
        assertThat(emmett.getWeapon()).isEqualTo("sword").as("Weapon should be Sword");
        assertThat(emmett.getBag()).isNotEmpty().hasSize(3).contains("Bow", "Axe", "Gold")
                .as("The bag should contain Bow, Axe, Gold");
        assertThat(emmett.isHuman()).isTrue().as("This is should be Human");
