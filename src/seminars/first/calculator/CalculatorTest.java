...
//        ).isInstanceOf(IllegalStateException.class);
        ...
        //TODO Home work 1
        testDistinctCorrect();
        testDistinctNegative();
        testDistinctResultNegative();
    }

    public static void testDistinctCorrect() {
        assertThat(Calculator.calculatingDiscount(120D, 20)).isEqualTo(100D);
    }

    public static void testDistinctNegative() {
        assertThatThrownBy(() -> Calculator.calculatingDiscount(100D, -10))
                .isInstanceOf(ArithmeticException.class);
    }
    public static void testDistinctResultNegative() {
